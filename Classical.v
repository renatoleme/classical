(*
    A Tableau system for Classical Propositional Logic.
    < coq v 8.13.1 >
 *)
...
Module Classical.
  ...
  | NOR : (logicalFormula * logicalFormula) -> logicalFormula.
  ...
  Definition inf000 := makeInitialTree
                        Root (((Node false ([P] \/ ~[P])))
                                ::nil).

  Compute print (pop (make inf000) _).
